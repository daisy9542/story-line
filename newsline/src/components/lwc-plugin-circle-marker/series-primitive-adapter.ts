import { DeepPartial, ISeriesApi, ISeriesPrimitive, SeriesType } from "lightweight-charts";
...
export class SeriesPrimitiveAdapter<
  T,
  Options = unknown,
  IPrimitive extends ISeriesPrimitiveWithOptions<T, Options> = ISeriesPrimitiveWithOptions<
    T,
    Options
  >,
  TSeriesType extends SeriesType = SeriesType,
> implements ISeriesPrimitiveWrapper<T, Options>
{
